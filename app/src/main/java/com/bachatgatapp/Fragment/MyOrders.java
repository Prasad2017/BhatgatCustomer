...
public class MyOrders extends Fragment {
   ...
   // public static String ORDERSLISTURL="http://prabhagmaza.com/androidApp/Customer/GetCartList.php";
    public static String ORDERSLISTURL="http://prabhagmaza.com/androidApp/Customer/viewcart.php";
