...
public class ProductList extends Fragment {
    ...
    public static String ProductlistURL="http://prabhagmaza.com/androidApp/Customer/Product_List.php";
    public static String GetCartURL="http://prabhagmaza.com/androidApp/Customer/cartcount.php";
    public static String FilterURL="http://prabhagmaza.com/androidApp/Customer/Filter.php";
    public static String LowURL="http://prabhagmaza.com/androidApp/Customer/getlow.php";
    public static String HignURL="http://prabhagmaza.com/androidApp/Customer/gethigh.php";
    public static String AtoZURL="http://prabhagmaza.com/androidApp/Customer/getAtoZ.php";
    public static String ZtoAURL="http://prabhagmaza.com/androidApp/Customer/getZtoA.php";
