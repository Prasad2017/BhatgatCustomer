...
public class ProductList extends Fragment {
    ...
    public static String ProductlistURL="http://logic-fort.com/androidApp/Customer/Product_List.php";
    public static String GetCartURL="http://logic-fort.com/androidApp/Customer/cartcount.php";
    public static String FilterURL="http://logic-fort.com/androidApp/Customer/Filter.php";
    public static String LowURL="http://logic-fort.com/androidApp/Customer/getlow.php";
    public static String HignURL="http://logic-fort.com/androidApp/Customer/gethigh.php";
    public static String AtoZURL="http://logic-fort.com/androidApp/Customer/getAtoZ.php";
    public static String ZtoAURL="http://logic-fort.com/androidApp/Customer/getZtoA.php";
